...
#define OVERMIND_ANNOUNCEMENT_MIN_SIZE 50 // Once the blob has this many structures, announce their presence | GCS CHANGE: 75 ==> 50
...
#define BLOB_NODE_MAX_HP 130 //GCS CHANGE: 200 ==> 130
...
#define BLOB_FACTORY_MAX_HP 130 //GCS CHANGE: 200 ==>
...
#define BLOB_REGULAR_MAX_HP 21 //GCS CHANGE: 25 ==> 21
#define BLOB_REGULAR_HP_INIT 16 // The starting HP of a normal blob tile | GCS CHANGE: 21 ==> 16
#define BLOB_REGULAR_HP_REGEN 1 // Health regenerated when pulsed by a node/core

#define BLOB_STRONG_MAX_HP 90 //GCS CHANGE: 150 == > 90
#define BLOB_STRONG_HP_REGEN 2

#define BLOB_REFLECTOR_MAX_HP 80 //GCS CHANGE: 150 == > 80
...
#define BLOB_POWER_REROLL_CHOICES 7 // Possibilities to choose from; keep in mind increasing this might fuck with the radial menu
...
#define BLOBMOB_BLOBBERNAUT_HEALTH 120 // Base blobbernaut health | GCS CHANGE: 200 ==> 120
