...
ADMIN_VERB(stop_weather, R_DEBUG | R_ADMIN, "Stop All Active Weather", "Stop all currently active weather.", ADMIN_CATEGORY_DEBUG) // Probably not needed but added incase.
